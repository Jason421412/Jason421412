...
🎓 Artificial Intelligence student with a **strong mathematical foundation** and a deep interest in **algorithms, computation, and theoretical aspects of AI**.  
I focus on understanding AI systems from **first principles**, rather than treating them as black-box tools.

---

### 🧠 Academic Focus
- 🤖 Artificial Intelligence with emphasis on **algorithmic reasoning**
- 📐 Strong interest in **mathematical structures behind computation**
- 🧩 Enjoy formal problem solving and abstraction
